...
let ProductsController = class ProductsController {
    ...
    create(createProductDto, image) {
        return this.productsService.create(createProductDto, image.buffer, image.originalname);
    }
    findAll(categoryIds) {
    ...
    update(id, updateUserDto, image) {
        return this.productsService.update(+id, updateUserDto, image.buffer, image.originalname);
    }
    remove(id) {
