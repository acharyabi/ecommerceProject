...
const admins_provider_1 = require("./admins.provider");
let AdminsModule = class AdminsModule {
};
exports.AdminsModule = AdminsModule;
exports.AdminsModule = AdminsModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([admin_entity_1.Admin])],
        controllers: [admins_controller_1.AdminsController],
        providers: [admins_service_1.AdminsService, ...admins_provider_1.adminProvider, admin_entity_1.Admin],
